...
#    Nov 04, 2022 09:03:43 AM PDT  platform: Linux
...
class Main:
    def __init__(self, top=None):
        ...
        if (widgetdemo_support.root.tk.call('tk', 'windowingsystem')=='aqua'):
            self.Entry1.bind('<Control-1>', lambda e: self.popup1(e))
            self.Entry1.bind('<Button-3>', lambda e: self.popup1(e))
        else:
            self.Entry1.bind('<Button-3>', lambda e: self.popup1(e))
        ...
        if (widgetdemo_support.root.tk.call('tk', 'windowingsystem')=='aqua'):
            self.TEntry1.bind('<Control-1>', lambda e: self.popup1(e))
            self.TEntry1.bind('<Button-3>', lambda e: self.popup1(e))
        else:
            self.TEntry1.bind('<Button-3>', lambda e: self.popup1(e))
    ...
    def popup1(self, event, *args, **kwargs):
        Popupmenu2 = tk.Menu(self.top, tearoff=0)
        Popupmenu2.configure(background=_bgcolor)
        Popupmenu2.configure(foreground=_fgcolor)
        Popupmenu2.configure(activebackground=_ana2color)
        Popupmenu2.configure(activeforeground='black')
        Popupmenu2.configure(font="TkMenuFont")
        Popupmenu2.add_command(compound='left',label='Copy')
        Popupmenu2.add_command(compound='left',label='Paste')
        Popupmenu2.add_command(compound='left',label='Clear')
        Popupmenu2.add_separator()
        Popupmenu2.add_command(command=widgetdemo_support.on_btnExit
                ,compound='left', label='Exit')
        Popupmenu2.add_separator()
        Popupmenu2.add_command(compound='left',label='Close Menu')
