...
proc ComboBox::create { path args } {
    ...
    set fg $::vTcl(pr,fgcolor)             ;# NEEDS WORK dark Rozen
    set bg $::vTcl(pr,bgcolor)             ;# NEEDS WORK dark Rozen
	...
	# Rozen added bg and fg optios in line below.
    Entry::configure $path.e -editable $editable -bg $bg -fg $fg
    if {$editable} {
