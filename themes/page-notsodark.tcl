#
# "Page-NotSoDark" theme.
# -------------------------------
# A semi-dark theme originally created for especially for the users of PAGE
# -------------------------------
...
# 09/12/2023 - Set ActiveForeground/ActiveBackground colors to "black"/"#d9d9d9" respectivly
#                  per Don's request
...
namespace eval ttk::theme::page-notsodark {
    variable version 0.1.19
    package provide ttk::theme::page-notsodark $version
    variable colors
    array set colors {
        -disabledfg     gray54
        -frame          black
    ...
    # Settings
    ttk::style theme create page-notsodark -parent clam -settings {
        ...
        ttk::style map TCheckbutton -indicatorbackground \
            ...
            -foreground [list active black disabled $colors(-disabledcolor)]
